...
In WSJT-CB, WSPR uses a dedicated source encoding that carries a full 11 m
CB callsign over the air; such transmissions are decodable only by other
WSJT-CB stations and are not uploaded to {wsprnet}.
